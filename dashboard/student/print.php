...
<body>
    <div class="topbtn">
    <!-- <input type="button" class="btn btn-primary" id="print-button" value="print"> -->
   


    <div class="main" id="hidden-div" style="align-center">

        <div class="top">
        <div class="top-right" style="float: right;margin-top: 57px;">
                    <table border="1" style="border-collapse:collapse">
                        <tr>
                            <td width="30"></td>
                            <td style="padding:5px; align:center;"><b> pan no:-602988144</td>
                            <td width="30"></td>
                        </tr>
                    </table>
                </div>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <div class="middle">
                ...
                <div class="middle-left" style="clear:both;">
                    ...
                    <div style="float:left;border-right: 2px solid; padding-right: 100px;">
                        ...
                        <input type="radio" id="first" <?php echo ($attempt === "1st") ? 'checked' : ''; ?> name="attempt"
                            value="1st" /><label for="first">1st</label>
                        <input type="radio" id="second" <?php echo ($attempt === "2nd") ? 'checked' : ''; ?>
                            name="attempt" value="2nd" /><label for="second">2nd</label>
                        <input type="radio" id="third" <?php echo ($attempt === "3rd") ? 'checked' : ''; ?> name="attempt"
                            value="3rd" /><label for="third">3rd</label>
                        <input type="radio" id="fourth" <?php echo ($attempt === "4th") ? 'checked' : ''; ?>
                            name="attempt" value="4th" /><label for="fourth">4th</label>
                        <br>
                        <!-- name -->
                        <label>First Name</label>
                        <input type="text" required name="fname" placeholder="Enter First name"
                            value="<?php echo $fname; ?>" maxlength="30" />
                            <!-- <br> -->
                        <!-- <label>Last Name</label> -->
                        <input type="text" name="lname" required placeholder="Enter Last name"
                            value="<?php echo $lname; ?>" maxlength="30" /><br><br>
                        <!-- jat -->
                        <label>Jaat</label>
                        <input type="text" name="jat" placeholder="Enter your jaat" value="<?php echo $jat; ?>"
                            maxlength="30" />
                        <br> <br>
                        <!-- main jat -->
                        <label>Main Jaat</label>
                        <input type="text" name="main_jat" placeholder="Enter your main jaat" maxlength="30"
                            value="<?php echo $main_jat; ?>" />
                        <br><br>
                        <!-- education -->
                        ...
                        <select name="education" id="edu">
                            ...
                            <option value="Bachelor" <?php echo ($education === "Bachelor") ? "selected" : ""; ?>>Bachelor
                            </option>
                        </select>
                        <br><br>
                        <!-- date of birth -->
                        <label for="datePicker">Date of Birth:</label>
                        <input type="date" id="datePicker" onchange="updateLabels()"
                            placeholder="Pick your birth date"><br><br>

                        <label id="bsLabel">BS:</label>
                        <input type="text" name="DOB" id="bsdate" placeholder="Birthday in BS"
                            value="<?php echo $DOB; ?>">
                        ...
                        <input type="text" name="religion" required maxlength="100" placeholder="Enter your religion"
                            value="<?php echo $religion; ?>" />
                        <br><br>
                        <!-- faculty -->
                        <label> Faculty</label>
                        <input type="text" name="faculty" required placeholder="Enter Faculty" maxlength="100"
                            value="<?php echo $faculty; ?>" />
                        <br><br>
                        <!--permanent address -->
                        <label>Permanent Address</label>
                        <input type="text" name="p_address" required placeholder="Enter Permanent District"
                            maxlength="100" value="<?php echo $p_address; ?>" />
                        <br><br>
                        <!--permanent ward -->
                        <label> Ward</label>
                        ...
                        <input type="text" name="p_txt_vdc_rm_mp" required placeholder="Please  choose your address"
                            maxlength="100" value="<?php echo $p_txt_vdc_rm_mp; ?>" />
                        <br><br>
                        <!--temporary address -->
                        <label>Temporary Address</label>
                        <input type="text" name="t_address" placeholder="Enter Temporary District" maxlength="100"
                        ...
                        <select name="t_vdc_rm_mp">
                            <option value="">Select</option>
                            <option value="V.D.C" <?php echo ($t_vdc_rm_mp === "V.D.C") ? "selected" : ""; ?>>V.D.C
                            </option>
                        ...
                        <input type="text" name="t_txt_vdc_rm_mp" placeholder="Please  choose your address"
                            maxlength="100" value="<?php echo $t_txt_vdc_rm_mp; ?>" />
                        <br><br>
                        <!-- contact number -->
                        <label>Contact no</label>
                        <input type="tel" id="phone" name="contact_no" placeholder="Enter your contact number" required
                ...
                <div class="middle-right" style="float:right;  position: relative;
                                                                text-align: right;
                                                                padding-right: 29px;
                                                                margin-top: -47px;">
                    <div>
                        <?php
                        // echo'<input type="file" class="photo" required name="photo">';
                        
                        // if ($row["photo"]) {
                        echo '<br><td><img id="hidephoto" width="100px" src="../../uploadsS/' .$row['photo']. '"alt="Image" style="float:top-right;"></td>';
                        ...
                        //   $changed_ph = $_FILES['foto']['name'];
                        //   echo '<br><td><img id="dhidephoto" width="100px" src="../../../uploadsS/'.$changed_ph. '"alt="Image"></td>';
                    ...
                    <input type="text" name="father_name" required placeholder="Enter father name" maxlength="30"
                        value="<?php echo $father_name; ?>" />
                    <br><br>
                    <!-- father's occupation -->
                    <label> Occupation</label>
                    <input type="text" name="f_occupation" placeholder="Enter occupation" maxlength="30"
                        value="<?php echo $f_occupation; ?>" />
                    <br><br>
                    <!-- contact number -->
                    <label>Contact no</label>
                    <input type="tel" id="phone" name="f_contact_no" placeholder="Enter occupation" required
                        value="<?php echo $f_contact_no; ?>">
                    <br>
                    <div class="opt-box">
                        ...
                        <input type="number" name="service_no" placeholder="Enter service number" maxlength="10"
                            value="<?php echo $service_no; ?>" />
                        <br>
                        <!-- rank -->
                        <label>Rank</label>
                        <input type="number" name="rank" placeholder="Enter Rank" maxlength="10"
                            value="<?php echo $rank; ?>" />
                        <br>
                        <!-- Registration -->
                        <label>Regtistration</label>
                        <input type="number" name="regt" placeholder="" maxlength="10"
                            value="<?php echo $regt; ?>" />
                        <br><br>
                    </div>
                    <br>
                    ...
                    <input type="text" name="mother_name" required placeholder="Full Mother name" maxlength="30"
                        value="<?php echo $mother_name; ?>" />
                    <br><br>
                    <!-- mother's occupation -->
                    <label> Occupation</label>
                    <input type="text" name="m_occupation" placeholder="Enter occupation" maxlength="30"
                        value="<?php echo $m_occupation; ?>" />
                    <br><br>
                    <!-- contact number -->
                    <label>Contact no</label>
                    <input type="tel" id="phone" name="m_contact_no" placeholder="Enter contact number" required
                        value="<?php echo $m_contact_no; ?>">
                    <br><br>
                    <!-- Guardian's detail -->
                    <label>Guradian's Name</label>
                    <input type="text" name="guradian_name" placeholder="Enter full name" maxlength="30"
                        value="<?php echo $guradian_name; ?>" />
                    <br><br>
                    <!-- Guardian relation -->
                    <label>Relation</label>
                    <input type="text" name="relation" placeholder="Enter relation" maxlength="30"
                        value="<?php echo $relation; ?>" />
                    <br><br>
                    <!-- Guardian contact -->
                    <label>Contact no</label>
                    <input type="number" name="r_contact_no" maxlength="10" placeholder="Enter contact number"
                        value="<?php echo $r_contact_no; ?>" />
                    <br><br>
            ...
            <div class="bottom" style="clear:both;">
                <br><br>
                <P>
                    <input type="checkbox" checked name="aggre"> <b> I will accept all the rules and regulation of this
                        institute and if do any
                        mistakes or if I’m not able to follow the rules and regulation of this institute then I will
                        accept any
                        punishment from this AIM GURKHA.</b>
                    <br>
                    <b> नोट: भर्ना गर्दा बुझाएको भर्ना शुल्क कुनै कारण बस CANDIDATE बिभिद कारणले ट्रेनिंग न आएमा या
                        ट्रेनिंग सेन्टर छोडेमा या बहिष्कार गरिएमा फेरी फिर्ता पाइने छैन,धन्यबाद |</b>
                </p>
            </div>
        </form>
