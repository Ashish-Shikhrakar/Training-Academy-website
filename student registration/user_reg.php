    ...
    <div class="master">
        ...
        <form method="post">
            <div class="middle">
                ...
                <div class="middle-left">
                    ...
                    <!-- attempt -->
                    <label>Attempt:</label>
                    1st<input type="radio" name="attempt" value="1st" />
                    2nd<input type="radio" name="attempt" value="2nd" />
                    3rd<input type="radio" name="attempt" value="3rd" />
                    4th<input type="radio" name="attempt" value="4th" />
                    <br><br>
                    <!-- name -->
                    <label>Name</label>
                    ...
                    <br><br>
                    <!--permanent VDC/RM/MP -->
                    <select name="p_vdc/rm/mp">
                        <option value="V.D.C">V.D.C<v /option>
                        <option value="R.M">R.M</option>
                        <option value="M.P">M.P"</option>
                    </select>
                    <input type="text" name="p_txt_vdc/rm/mp" required placeholder="" maxlength="100" />
                    <br><br>
                    <!--temporary address -->
                    ...
                    <br><br>
                    <!--temporary VDC/RM/MP -->
                    <select name="t_vdc/rm/mp">
                        <option value="V.D.C">V.D.C<v /option>
                        <option value="R.M">R.M</option>
                        <option value="M.P">M.P"</option>
                    </select>
                    <input type="text" name="t_txt_vdc/rm/mp" required placeholder="" maxlength="100" />
                    <br><br>
                    <!-- contact number -->
                ...
                <div class="middle-right">
                    ...
                    <input type="tel" id="phone" name="f_contact_no" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                    <br><br>
                    ...
                    <!-- contact number -->
                    <label>Contact no</label>
                    <input type="tel" id="phone" name="m_contact_no" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                    <br><br>
                    <!-- Guardian's detail -->
        ...
        <div class="bottom">
            <P>
                ...
                <input type="checkbox">  I will accept all the rules and regulation of this institute and if do any
