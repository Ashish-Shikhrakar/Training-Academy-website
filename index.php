...
<body>
    <div class="wrapper">
        ...
        <section class="contentbox">
            ...
            <p class="introtext">
                Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</br>
        ...
        <div class="container">
            <div class="introtitle">Gallery</div>

            <div class="mySlides">
                <img src="photo/img2.png" style="width:100%">
            </div>
          
            <div class="mySlides">
                <img src="photo/FloodedKabulwide.png" style="width:100%">
            </div>
          
            <div class="mySlides">
                <img src="photo/img3.png" style="width:100%">
            </div>
        ...
        <div class="container">
            <div>
                <img src="photo/trainers.jpg" style="width:100%">
            </div>
        </div>
        <div class="container">
                  ...
                  <div class="responsive-container-block">
                    <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                      <div class="team-card">
                        ...
                        <p class="text-blk position introtext">
            ...
            <div class="mySlides2">
                <div class="responsive-container-block outer-container">
                    <div class="responsive-container-block inner-container">
                      ...
                      <div class="responsive-container-block">
                        <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container" style="width: 170px;">
                          <div class="team-card">
                            <div class="img-wrapper">
                              <img class="team-img" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/expert1.png">
                            </div>
                            ...
                            <div class="img-wrapper" style="width: auto;">
                                <img class="team-img" src="photo/5str.png">
                            </div>
                      ...
                      <p class="text-blk position introtext">
                        <i>"Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum,
                            nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris."</i>
                      </p>
                    </div>
                </div>
            </div>
              ...
              <div class="responsive-container-block">
                  <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr auto; align-items: center;">
                      ...
                      <div><a href="#"><i class="icon ion-social-facebook"></i></a><a href="#"><i class="icon ion-social-twitter"></i></a><a
